...
// in coop mode, we're using the real boss.qc
#ifdef PR_COOP_MODE_ENHANCED
//#pragma DONT_COMPILE_THIS_FILE
#else   //#endif   PZ: changed
...
*/
/*
CH To save space, remove the boss crap.  see end comment below
...
$frame attack23
*/
enum {FR_SHOCKA1, FR_SHOCKA2, FR_SHOCKA3, FR_SHOCKA4, FR_SHOCKA5, FR_SHOCKA6, FR_SHOCKA7, FR_SHOCKA8};
enum {FR_SHOCKA9 = 8, FR_SHOCKA10};

enum {FR_SHOCKB1 = 10, FR_SHOCKB2, FR_SHOCKB3, FR_SHOCKB4, FR_SHOCKB5, FR_SHOCKB6};

enum {FR_SHOCKC1 = 16, FR_SHOCKC2, FR_SHOCKC3, FR_SHOCKC4, FR_SHOCKC5, FR_SHOCKC6, FR_SHOCKC7, FR_SHOCKC8};
enum {FR_SHOCKC9 = 24, FR_SHOCKC10};
/*
...
CH here is a good place to stop as the below is in some maps
*/
entity	le1, le2;
float	lightning_end;
...
void lightning_use()
{
	...
	{
		RPrint ("missing lightning targets\n");
		return;
	}
